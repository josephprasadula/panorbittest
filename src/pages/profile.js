      ...
      <div className=" ml-[3.2rem] w-full">
        <div className="flex justify-between items-center border-b-2 border-slate-200 w-full pb-[1rem]">
          ...
          {showSettingModal && (
            <div
              ref={modalRef}
              className="modal bg-white h-fit w-fit px-[2rem] py-[2.75rem] absolute right-28 top-28 z-10 shadow-xl rounded-xl"
            >
              <img
              ...
              <button className="bg-[#d55151] rounded-xl py-[11px] px-[1rem] w-fit mx-auto text-[white]">
                Sign Out
              </button>
            </div>
          )}
